...
var storagePools = _.map(_.range(1, 100), function (v) {
    ...
    var capacityInBytes = getCapacity(200, 300),
        ...
        logicalCapacityInBytes = getCapacity(200, 300),
        usedLogicalCapacityInBytes = getCapacity(100, 200),
        availableLogicalCapacityInBytes = getCapacity(50, 100),
    ...
    return {
        ...
        "logicalCapacityInBytes": logicalCapacityInBytes,
        "usedLogicalCapacityInBytes": usedLogicalCapacityInBytes,
        "availableLogicalCapacityInBytes": availableLogicalCapacityInBytes,
        "type": type,
