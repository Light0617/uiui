...
/**
 * @ngdoc directive
 * @name rainierApp.directive:summary-alert-panel
 * @description
 * # summaryAlertPanel
 */
angular.module('rainierApp')
    .directive('summaryAlertPanel', function () {
        return {
            scope: false,
            templateUrl: 'views/templates/summary-alert-panel.html',
            restrict: 'E',
            controller: function ($scope, monitoringService) {
                ...
                $scope.capacityComponents = monitoringService.getCapacityComponents();
                $scope.components = monitoringService.getHardwareComponents();

                $scope.launchMonitoringPage = function (alertCount) {
                    monitoringService.launchDpMonitoring(alertCount);
                } ;
                ...
                function initView() {
                    $scope.toggleAction(monitoringService.getCurrentCategory());
