...
angular.module('rainierApp')
    .controller('PhysicalStorageSystemInVsmCtrl', function (
        ...
        resourceTrackerService, volumeService, virtualizeVolumeService, utilService, $modal, storageSystemVolumeService, $q
    ) {
        ...
        paginationService.get(null, GET_VOLUMES_PATH, objectTransformService.transformVolume, true, physicalStorageSystemId).then(function (result) {
        ...
        orchestratorService.physicalStorageSystemSummaryInVsm(virtualStorageMachineId, physicalStorageSystemId).then(function(result){
            var summaryModel = [];
            var item = {
                    resource: 'Volume',
