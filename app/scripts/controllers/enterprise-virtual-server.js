        ...
        orchestratorService.enterpriseVirtualServer(storageSystemId, evsId).then(function (evs) {
            ...
            orchestratorService.filePools(storageSystemId).then(function (fps) {
                ...
                _.forEach(fileSystems, function (fileSystem) {
                    ...
                    if (!_.find(pools, function(pool) { return pool.id === fileSystem.filePoolId; })) {
                ...
                fileSystems = linkLabelService.replaceEVSUuidWithLabel(fileSystems, result);
