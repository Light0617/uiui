...
angular.module('rainierApp')
    .controller('FileSystemCtrl', function ($scope, $routeParams, $timeout, $filter, diskSizeService, fileSystemService,
        ...
        orchestratorService.exports(storageSystemId, fileSystemId).then(function (result) {
            ...
            evs = _.find(virtualFileServers.evses, function (fileServer) {
                return fileServer.id === fileSystem.evsId;
            });
            var summaryModel = {};
            var shareLength = 0;
            var exportLength = 0;
            ...
            shares = linkLabelService.replaceFSIdWithLabel(shares, fileSystem);
            exports = linkLabelService.replaceFSIdWithLabel(exports, fileSystem);
            var fileSystems = [fileSystem];
            var filePools = [filePool];
            fileSystem = linkLabelService.replacePoolIdWithLabel(fileSystems, filePools)[0];
            var dataModel = {
                file: true,
