...
angular.module('rainierApp')
    .factory('orchestratorService', function (Restangular, objectTransformService, apiResponseHandlerService, replicationService) {
        ...
        var service = {
            ...
            removeUndefinedResources: function(virtualStorageMachineId, payload) {
                return apiResponseHandlerService._apiResponseHandler(Restangular.one('virtual-storage-machines', virtualStorageMachineId).one('remove-undefined-resources').post(payload));
            },
            addUndefinedResources: function (virtualStorageMachineId, payload) {
                return apiResponseHandlerService._apiResponseHandler(Restangular.all('virtual-storage-machines/' + virtualStorageMachineId + '/add-undefined-resources').post(payload));
            },
            ...
            deletePhysicalStorageSystemFromVsm: function(virtualStorageMachineId, physicalStorageSystemId){
                return apiResponseHandlerService._apiResponseHandler(Restangular.one('virtual-storage-machines',
                    virtualStorageMachineId).one('physical-storage-systems', physicalStorageSystemId).remove());
            },
            ...
            discoverLun: function (portId, storageSystemId, payload) {
            ...
            virtualizeVolumes: function(storageSystemId, payload){
                return apiResponseHandlerService._apiResponseHandler(Restangular.all('external-volume-manager/create').post(payload));
            },
            deleteExternalVolumes: function (payload) {
                return apiResponseHandlerService._apiResponseHandler(Restangular.all('/external-volume-manager/delete').post(payload));
            },
            ...
            discoveredLuns:  function(targetStorageSystemId, targetPortId, payload) {
                return apiResponseHandlerService._apiGetResponseHandler(Restangular.one('storage-systems/' + targetStorageSystemId + '/storage-ports/' + targetPortId + '/discover-groups').post(payload));
            },
